# Generated by Django 3.0 on 2023-09-02 15:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('daily_meals', models.ManyToManyField(to='core.DailyMeal')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('category', models.CharField(choices=[('breakfast', 'Colazione'), ('launch', 'Pranzo'), ('dinner', 'Cena'), ('snack_morning', 'Spuntino mattina'), ('snack_afternoon', 'Spuntino pomeriggio'), ('before_sleep', 'Pre nanna')], default='colazione', max_length=256)),
                ('name', models.CharField(blank=True, max_length=256, null=True)),
